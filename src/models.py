...
#   timestamp: 2023-04-18T21:00:53+00:00
...
class RecipientKey3(RecipientKey):
    pass


class RoutingKey4(RoutingKey):
    pass


class ServiceDecorator(BaseModel):
    recipientKeys: List[RecipientKey3] = Field(
        ..., description='List of recipient keys'
    )
    routingKeys: Optional[List[RoutingKey4]] = Field(
        None, description='List of routing keys'
    )
...
class OobRecord(BaseModel):
    ...
    role: Optional[Role1] = Field(None, description='OOB Role', example='receiver')
    state: State = Field(
...
class V20PresExRecord(BaseModel):
    ...
    state: Optional[State2] = Field(None, description='Present-proof exchange state')
    thread_id: Optional[str] = Field(
        None,
        description='Thread identifier',
        example='3fa85f64-5717-4562-b3fc-2c963f66afa6',
